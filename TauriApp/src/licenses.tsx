...
const licenses = () => {
    return (
        <div className="dark:text-white text-lg w-11/12 mx-auto pb-5">
            ...
            <p>Conform Sidekick Copyright © 2024 by Beau Wright and is avaliable for use under the <a href="https://github.com/beauwright/Conform-Sidekick/blob/main/LICENSE" target="_blank" className="underline">GNU General Public License v3.0 license</a>.</p>
            ...
            <ul className="ml-7 list-disc">
                <li><a href="https://github.com/python-pillow/Pillow" target="_blank" className="underline">Pillow</a>  - Copyright © 2010-2024 by Jeffrey A. Clark and contributors - used under the open source HPND License.</li>
